...
export function OurFleet() {
  return (
    <div className="max-w-6xl mx-auto text-center py-12 lg:py-40 p-6">
      <h3 className="text-2xl lg:text-6xl font-bold">Nuestros Vehículos</h3>
      <p className="text-lg mt-2 lg:mt-5 lg:text-xl text-center w-full mx-auto max-w-2xl mb-5 lg:mb-10">
      No te niegues el placer de conducir los mejores coches premium de todo el mundo.
      el mundo aquí y ahora el mundo
      </p>
